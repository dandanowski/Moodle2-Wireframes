...
<div id="cp-detail">
    ...
    <div class="cp-header">
        ...
        <div class="filters">
            <ul class="group">
                <li class="status active">Completion Status</li>
    ...
    <div class="cp-report">
        ...
        <dl class="group status incomplete" data-count="4">
            <dt>Incomplete</dt>
            <dd>
                <dl class="course">
        ...
        <dl class="group status notattempted" data-count="3">
            <dt>Not Attempted</dt>
            <dd class="hide">
                <dl class="course">
        ...
        <dl class="group status complete" data-count="5">
            <dt>Complete</dt>
            <dd class="hide">
                <dl class="course">
                    <dt>Help</dt>
        ...
        <dl class="group course courses hide">
            <dt>Advanced Learning for Excel 2003</dt>
            <dd class="hide">
                <ul class="modules">
                    <li data-status="0">Advanced Excel 2003 Module</li>
